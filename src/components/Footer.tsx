      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://github.com/anshumeshsaini" className="text-foreground/60 hover:text-meme-purple transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="border-t border-white/5 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <a href="https://github.com/anshumeshsaini" className="text-foreground/60 hover:text-meme-purple transition-colors text-sm inline-flex items-center">
              Developers
